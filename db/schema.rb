...
ActiveRecord::Schema.define(version: 20160513152047) do
  ...
  add_index "constructions", ["buyer_id_id"], name: "index_constructions_on_buyer_id_id"
  ...
  add_index "easements", ["buyer_id_id"], name: "index_easements_on_buyer_id_id"
  ...
  add_index "liens", ["buyer_id_id"], name: "index_liens_on_buyer_id_id"
  ...
  add_index "manufactured_homes", ["buyer_id_id"], name: "index_manufactured_homes_on_buyer_id_id"
  ...
  add_index "mortgages", ["buyer_id_id"], name: "index_mortgages_on_buyer_id_id"
  ...
  add_index "occupancies", ["buyer_id_id"], name: "index_occupancies_on_buyer_id_id"
  ...
  add_index "prior_policies", ["buyer_id_id"], name: "index_prior_policies_on_buyer_id_id"
  ...
  add_index "property_uses", ["buyer_id_id"], name: "index_property_uses_on_buyer_id_id"
  ...
  add_index "taxes", ["buyer_id_id"], name: "index_taxes_on_buyer_id_id"
